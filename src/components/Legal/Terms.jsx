  ...
  return (
    <div className={styles.legalPage}>
      <div className={styles.formContainer}>
        ...
        <p className={styles.date}>Last updated May 09, 2018</p>
        <p>
          Please read these Terms and Conditions ("Terms", "Terms and
          Conditions") carefully before using the
          <a href="http://www.baseballcloud.com">
            http://www.baseballcloud.com
          </a>
          website (the "Service") operated by DaTraks LLC ("us", "we", or
          "our").
        </p>
        <p>
        ...
        <p>
          ...
          to support@baseballcloud.com, with the subject line: "Copyright
